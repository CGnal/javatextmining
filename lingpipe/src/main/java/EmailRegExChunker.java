...
public class EmailRegExChunker extends RegExChunker {
    ...
    public static void main(String[] uiui) {

        String[] args = "John's email is john@his.company.com and his friend's is foo.bar@123.foo.ca".split(" ");
        ...
        for (int i = 0; i < args.length; ++i) {
            ...
            for (Chunk chunk : chunking.chunkSet()) {
                ...
                int end = chunk.end();
                String text = args[i].substring(start,end);
