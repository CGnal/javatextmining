...
import akka.http.scaladsl.model.{HttpResponse, ContentTypes, HttpRequest}
...
/**
  *
  */
object AlchemyEntityExtractor extends NamedEntityExtractor with HttpClient with SprayJsonSupport with DefaultJsonProtocol {
