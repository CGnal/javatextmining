...
public class NERClassifierCombiner extends ClassifierCombiner<CoreLabel> {
   ...
   */
  public static edu.stanford.nlp.ie.NERClassifierCombiner createNERClassifierCombiner(String name, Properties properties) {
   ...
   *  @return An NERClassifierCombiner with the given properties
   */
  public static edu.stanford.nlp.ie.NERClassifierCombiner createNERClassifierCombiner(String name,
    ...
    edu.stanford.nlp.ie.NERClassifierCombiner nerCombiner;
    try {
      ...
      nerCombiner = new edu.stanford.nlp.ie.NERClassifierCombiner(applyNumericClassifiers,
  ...
  public static edu.stanford.nlp.ie.NERClassifierCombiner getClassifier(String loadPath, Properties props) throws IOException,
          ClassNotFoundException, ClassCastException {
    ObjectInputStream ois = IOUtils.readStreamFromString(loadPath);
    edu.stanford.nlp.ie.NERClassifierCombiner returnNCC = getClassifier(ois, props);
    IOUtils.closeIgnoringExceptions(ois);
    return returnNCC;
  }

  // static method for getting an NERClassifierCombiner from an ObjectInputStream
  public static edu.stanford.nlp.ie.NERClassifierCombiner getClassifier(ObjectInputStream ois, Properties props) throws IOException,
          ClassNotFoundException, ClassCastException {
    return new edu.stanford.nlp.ie.NERClassifierCombiner(ois, props);
  }

  // method for displaying info about an NERClassifierCombiner
  public static void showNCCInfo(edu.stanford.nlp.ie.NERClassifierCombiner ncc) {
    System.err.println("");
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.setProperty("textFile","/Users/dgesino/workspace/experiments/javatextmining/corenlp/src/main/resources/prova.txt");
    ...
    edu.stanford.nlp.ie.NERClassifierCombiner ncc;
    if (loadPath != null) {
